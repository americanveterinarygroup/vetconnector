...
if __name__ == '__main__':
    try:
        logging_config.logger('./logs/uv_dvm_report_download.log')
        ...
        doctors.to_csv('./source_docs/UV_DoctorList.csv', index=False)
    ...
    time.sleep(5)
    chrome.get('https://app.powerbi.com/groups/58a5001e-4b10-4c6e-a27f-05c157db4955/reports/f688e593-c936-47d9-acc5-87d48df863bc/ReportSection3d15daab630d570b3efd?experience=power-bi')
    time.sleep(15)
    ...
    for idx in doctors.index:
        try:
            ...
            save_pdf = f"C:/dvm_monthly_distribution/pdfs/uv_staging/monthly_report/{id}_DvmMonthlyReport.pdf"
